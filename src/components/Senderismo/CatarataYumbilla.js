...
const CatarataYumbilla = () => {
  return (
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <div className={styles.mapContainer}>
          <iframe
            ...
            width="100%" // Puedes ajustar el ancho como desees
            height="450"
            style={{ border: 0 }}
            allowFullScreen=""
            loading="lazy"
      ...
      <Botones prevPath="/senderismo" nextPath="/senderismo/volverahome" />
    </div>
  );
};
